...
3. The state of StatefulComponent should be initialized with a property name set to a string.
4. The property name in the state of StatefulComponent should render in the h1 element.
*/
