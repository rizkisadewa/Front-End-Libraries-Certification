...
3. The third child of MyToDoList should be a button element.
4. The state of MyToDoList should be initialized with toDoList as an empty array.
5. The state of MyToDoList should be initialized with userInput as an empty string.
6. When the Create List button is clicked, the MyToDoList component should dynamically return an unordered list that contains a list item element
   for every item of a comma-separated list entered into the textarea element.
*/
