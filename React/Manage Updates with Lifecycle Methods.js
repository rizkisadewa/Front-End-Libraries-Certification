...
This method works similar to componentWillUpdate(), which is provided for you. Now click the button to change the message and watch your browser console.
The order of the console statements show the order the methods are called.

Note: You'll need to write the lifecycle methods as normal functions and not as arrow functions to pass the tests
(there is also no advantage to writing lifecycle methods as arrow functions).

1. The Controller component should render the Dialog component as a child.
2. The componentWillReceiveProps method in the Dialog component should log this.props to the console.
3. The componentWillReceiveProps method in the Dialog component should log nextProps to the console.
4. The Dialog component should call the componentDidUpdate method and log a message to the console.
*/
