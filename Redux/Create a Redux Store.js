...
it must do so through the Redux store. The unidirectional data flow makes it easier to track state management in your app.
...
1. The redux store exists.
2. The redux store has a value of 5 for the state.
*/
