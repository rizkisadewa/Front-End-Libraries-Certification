...
There is a store and reducer in the code editor for managing to-do items. Finish writing the ADD_TO_DO case in the reducer to append a new to-do to the state.
...
1. he Redux store should exist and initialize with a state equal to the todos array in the code editor.
