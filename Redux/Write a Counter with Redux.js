...
/*
Now you've learned all the core principles of Redux! You've seen how to create actions and action creators,
create a Redux store, dispatch your actions against the store, and design state updates with pure reducers.
...
The basics are provided in the code editor, but you'll have to fill in the details! Use the names that are provided and define incAction
and decAction action creators, the counterReducer(), INCREMENT and DECREMENT action types,
...
3. The Redux store should initialize with a state of 0.
4. Dispatching incAction on the Redux store should increment the state by 1.
5. Dispatching decAction on the Redux store should decrement the state by 1.
6. counterReducer should be a function
*/
